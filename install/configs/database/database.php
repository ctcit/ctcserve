...
$db['ctcweb9_joom1']['hostname'] = "db";
$db['ctcweb9_joom1']['username'] = "root";
$db['ctcweb9_joom1']['password'] = "docker";
...
$db['ctcweb9_tripreports']['hostname'] = "db";
$db['ctcweb9_tripreports']['username'] = "root";
$db['ctcweb9_tripreports']['password'] = "docker";
