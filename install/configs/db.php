...
define("DEVEL", TRUE);  // Set this FALSE when deploying to www.example.com
/*
|--------------------------------------------------------------------------
| Base Site URL
|--------------------------------------------------------------------------
...
$config['base_url'] = defined("DEVEL") && DEVEL ?
        "http://localhost/db" : "http://www.example.com/db";
/*
|--------------------------------------------------------------------------
...
$config['joomla_base'] = defined("DEVEL") && DEVEL ?
        "/var/www/html/" : "/home/example/public_html/";
/*
|--------------------------------------------------------------------------
| Joomla Base URL
|--------------------------------------------------------------------------
...
| Currently (May 2008) the only roles with full access are webmaster,
| dbadmin, secretary and treasurer.
 */
